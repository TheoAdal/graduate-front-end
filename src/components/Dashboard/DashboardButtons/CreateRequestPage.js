...
export default function RequestPage() {
  ...
  const handleRequestSubmit = async (e) => {
    ...
    if (!preferredAge || !preferredGender || !preferredCity || !appointmentDate || !appointmentTime || !description) {
    ...
    if (
      error.response &&
      error.response.data &&
      error.response.data.message === "An appointment already exists for this date"
    ) {
